Contributing to PIVXL Core
============================

The PIVXL Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/pivxl-project/pivxl/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PIVXL Core project, and is not to be
confused with overall PIVXL Network Protocol consensus changes.

Whether a pull request is merged into PIVXL Core rests with the project merge
...
Patches that change PIVXL consensus rules are considerably more involved than
...
Where a patchset proposes to change the PIVXL consensus, it must have been
...
The project leader is the release manager for each PIVXL Core release.
