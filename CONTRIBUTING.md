Contributing to PIVXL
============================

The PIVXL project operates an open contributor model where anyone is
...
The following applies to code changes to the PIVXL project, and is not to be
confused with overall PIVXL Network Protocol consensus changes.

Whether a pull request is merged into PIVXL rests with the project merge
...
The project leader is the release manager for each PIVXL release.
