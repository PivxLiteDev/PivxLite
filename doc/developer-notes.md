...
- [Development guidelines](#development-guidelines)
    - [General PIVXL](#general-pivxl-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
PIVXL uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
PIVXL is a multi-threaded application, and deadlocks or other
...
**Sanitizers**
PIVXL can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as PIVXL, where everyone uses
...
pay attention to for reviewers of PIVXL code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PIVXL uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against PIVXL so that they can be integrated
