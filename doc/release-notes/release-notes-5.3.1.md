PIVXL version v5.3.1 is now available from: https://github.com/pivxl-project/pivxl/releases
...
If you are running an older version, shut it down. Wait until it has completely shut down, then run the installer (on Windows) or just copy over /Applications/PIVXL-Qt (on Mac) or pivxld/pivxl-qt (on Linux).
