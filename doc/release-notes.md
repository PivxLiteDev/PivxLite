PIVXL Core version *4.1.1* is now available from:  <https://github.com/pivxl-project/pivxl/releases>
...
PIVXL Core v4.1.1 is a **mandatory** update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
