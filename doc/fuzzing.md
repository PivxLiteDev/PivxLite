...
To build PIVXL using AFL instrumentation (this assumes that the
...
with certain assembly code from PIVXL's code. See [developer notes on sanitizers](https://github.com/PIVXL-Project/PIVXL/blob/master/doc/developer-notes.md#sanitizers)
