...
The build script we'll be using is contained in the PIVXL github repository ([contrib/gitian-build.py](https://github.com/pivxl-project/pivxl/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the PIVXL repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/PIVXL-Project/PIVXL/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, pivxl-detached-sigs, and pivxl GitHub repos.
