...
The script [extract-osx-sdk.sh](https://github.com/pivxl-project/pivxl/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
pivxl/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/pivxl-project/pivxl/blob/master/doc/README_osx.md) for troubleshooting tips.