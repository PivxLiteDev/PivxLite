...
This means one can have an always-on pivxlld instance running, and another local pivxlld/pivxl-qt instance which connects to this node and receives blocks from it.
