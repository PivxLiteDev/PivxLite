...
This means one can have an always-on pivxld instance running, and another local pivxld/pivxl-qt instance which connects to this node and receives blocks from it.
