...
# Copyright (c) 2018-2019 The PIVXL developers
...
Arguments:
    <base_directory> - The base directory of a pivxl source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The PIVXL developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The PIVXL developers'
                 % (filename))
