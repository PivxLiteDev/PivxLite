...
Provides utilities for managing copyright headers of `The PIVXL
...
PIVXL-Project/PIVXL repository.
...
Setup
---------
Configuring the github-merge tool for the PIVXL repository is done in the following way:

    git config githubmerge.repository PIVXL-Project/PIVXL
...
A script to optimize png files in the PIVXL
