...
By default, pivxld will dump mempool on shutdown and
...
class MempoolPersistTest(PivxlTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent pivxld from writing mempool.dat to disk. Verify that `savemempool` fails")
