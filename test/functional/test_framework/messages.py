...
COIN = 100000000 # 1 PIVXL in satoshis
...
# Objects that map to pivxld objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in pivxld indicates these should be deserialized as blocks
