...
class WalletTest(PivxlTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PIVXL from 1 to 0 using sendtoaddress call.
        ...
        # Node 1 has:
        # - 1 coin of 1.00 PIVXL
        # - 7 coins of 250.00 PIVXL
        # - 1 coin of 228.9999xxxx PIVXL
