...
class FullBlockTest(PivxlTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure pivxld isn't accepting b26
        ...
        # Extend the b28 chain to make sure pivxld isn't accepting b28
        ...
        # PIVXL: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the pivxl code has custom code which does so);
