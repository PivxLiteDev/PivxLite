...
class DIP3Test(PivxlTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 PIVXL) to the operator, and (2 * 2.7 PIVXL) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid PIVXL address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid PIVXL address InvalidPayee", controller.protx_update_registrar,
