...
class BlockIndexStatsTest(PivxlTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 PIVXL "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 PIVXL + 9 notes of 5 PIVXL + 1 note of 4 PIVXL (using 1.0 fee)
