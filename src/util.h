...
extern const char * const PIVXL_CONF_FILENAME;
extern const char * const PIVXL_PID_FILENAME;
extern const char * const PIVXL_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("pivxl-%s", name);
