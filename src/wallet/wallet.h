...
#ifndef PIVXL_WALLET_H
#define PIVXL_WALLET_H
...
public:
     ...
     * PIVXL: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 PIVXL output and keys which can be used for the Masternode
