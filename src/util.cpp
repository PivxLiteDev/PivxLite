...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "pivxl" is a composite category enabling all PIVXL-related debug output
            if (ptrCategory->count(std::string("pivxl"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "pivxl.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "pivxld.pid"));
