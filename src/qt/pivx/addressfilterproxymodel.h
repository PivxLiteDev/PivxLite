...
#ifndef PIVXL_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define PIVXL_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //PIVXL_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
