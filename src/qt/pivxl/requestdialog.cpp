    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of only sharing a PIVXL address, you can create a Payment Request message which bundles up more information than is contained in just a PIVXL address."));
