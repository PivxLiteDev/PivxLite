...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " pivxl-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  pivxl-tx [options] <hex-tx> [commands]  Update hex-encoded pivxl transaction\n" +
                               "or:     pivxl-tx [options] -create [commands]   Create hex-encoded pivxl transaction\n" +
                               "\n";
