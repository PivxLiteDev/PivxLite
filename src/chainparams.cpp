...
public:
    ...
    //  vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "pivxl-testnet.seed.fuzzbawls.pw", true));
    //  vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "pivxl-testnet.seed2.fuzzbawls.pw", true));
